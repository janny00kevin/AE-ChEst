...
if mode == 'train':
    ...
    sparseChannel = Training_Dataset['SparseChan'][:50,:]
    receivedSignal = Training_Dataset['ReceivedSig'][:50,:]
    groundChannel = Training_Dataset['GroundChan'][:50,:]
    ...
    for e in range(epochs):
        ...
        for batch in tqdm(dataloader_train):
            ...
            while k < k_max:
                ...
                converge, normalized_prim, normalized_dual, sum_primal_converge, sum_dual_converge = convergence_criterion(norm_r, norm_s, x_new_, h_hat_, temp, n_param, ep_abs=3e-3, ep_rel=3e-3)
